...
public class AddDishBussActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dish_buss);
        ...
        dishName = findViewById(R.id.dishNameEditTxtView);
        dishPrice = findViewById(R.id.dishPriceEditTxtView);
        dishDescription = findViewById(R.id.dishDescriptionMultiLine);
    ...
    private void addDish() {
        ...
        dbRef.push().setValue(dish).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(AddDishBussActivity.this,"Dish Added!",Toast.LENGTH_LONG).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AddDishBussActivity.this,"Failed To Add Dish!",Toast.LENGTH_LONG).show();
            }
        });
