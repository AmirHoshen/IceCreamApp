...
//        }
        ...
        dbRef.push().setValue(new Upload(title.getText().toString(),description.getText().toString(),Double.parseDouble(price.getText().toString()),image,tag)).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
